...
/* open boundary */
void ReadParameters(float* LengthRef, float* tau, float *nu, float *VelInt, float* RhoInt, float* PresInst, float* velocity_bc, float *pressure_bc, int* timesteps, int* timesteps_per_plotting, int argc, char* argv[], int* gpu_enabled);
/**
